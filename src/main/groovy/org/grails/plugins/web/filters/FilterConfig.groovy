...
class FilterConfig implements Controller {
    ...
    def getWiredFiltersDefinition() {
        ...
        final GrailsClass grailsFilter = webRequest ? grailsApplication.getArtefact(org.grails.plugins.web.filters.FiltersConfigArtefactHandler.TYPE, filtersDefinition.class.name) : null
        if (grailsFilter) {
